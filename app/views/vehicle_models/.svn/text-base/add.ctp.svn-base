...
<fieldset>
<legend><?php __("Add Vehicle Model");?></legend><br/>
<?=$form->create("VehicleModel",array("action"=>"add"));?>
<?
echo "<pre>";
?>
...
<tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <td align="left"><?=$form->error("vehicle_model_name");?><?=$form->input("VehicleModel.vehicle_model_name",array("size"=>"25","label"=>false));?>				  </td>
  </tr>
   <tr>
...
echo "</pre>";
?>
<div align="right" style="background:#ecebff"><?php echo $html->link("View All","/vehicle_models/index/"); ?>
</div>
</form>
</fieldset>
</div>